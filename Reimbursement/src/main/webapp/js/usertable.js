function renderTable(reimbursements) {
    for (const reimbursement of reimbursements) {
        ...
        reimAuth.innerHTML = reimbSubmit.author;
        reimResolver.innerHTML = reimbursement.resolver;
        reimStatus.innerHTML = reimbursement.status;
        reimType.innerHTML = reimbursement.type;
